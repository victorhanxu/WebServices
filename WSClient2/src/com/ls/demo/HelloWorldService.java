 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://demo.ls.com/", wsdlLocation = "http://localhost:9000/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://demo.ls.com/", "HelloWorldService");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://demo.ls.com/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo.ls.com/", "HelloWorldPort"), HelloWorld.class, features);
    }
