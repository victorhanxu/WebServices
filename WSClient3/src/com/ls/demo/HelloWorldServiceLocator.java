...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.ls.demo.HelloWorldService {
    ...
    public com.ls.demo.HelloWorld getHelloWorldPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.ls.demo.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ls.demo.HelloWorldPortBindingStub _stub = new com.ls.demo.HelloWorldPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ls.demo.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ls.demo.HelloWorldPortBindingStub _stub = new com.ls.demo.HelloWorldPortBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://demo.ls.com/", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://demo.ls.com/", "HelloWorldPort"));
        }
